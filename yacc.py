...
# - Class and function definitions for creating an easy to traverse
#   syntax tree
# - The defintions to generate a parser through YACC
# - The function to use the generated parser to build the syntax tree
# ------------------------------------------------------------
...
class FunctionCall_Node(Node):
    def __init__(self, function_name, pars):
        self.type = 'call_function'
        self.function_name = function_name
        self.pars = pars
        self.children = [function_name, pars]
        self.leaf = None
...
def p_array_type(p):
    '''type : type LBRACK NUMBER RBRACK'''
    p[0] = Node("array_type", p[3], p[1])
